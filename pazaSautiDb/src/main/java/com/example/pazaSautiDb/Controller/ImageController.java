...
public class ImageController {
    ...
    @GetMapping(
            ...
            produces = {MediaType.IMAGE_JPEG_VALUE,MediaType.IMAGE_GIF_VALUE,MediaType.IMAGE_PNG_VALUE,MediaType.APPLICATION_PDF_VALUE,MediaType.MULTIPART_FORM_DATA_VALUE}
    )
